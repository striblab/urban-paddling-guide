...
<div class="hero bg-[#fffbf4] pb-20">
    ...
    <div class="subhead w-[90%] mx-auto">
        <h1
            class="font-publico-banner-black text-[40px] md:text-[60px] text-center mx-auto text-white mt-[-100vh] pt-[33vh] md:pt-[38vh] max-w-4xl"
        >
            Your ultimate guide to paddling in the Twin Cities
        </h1>
        <div
        ...
        >
            ...
            <p class="mb-6">
                ...
                But getting out there in the Twin Cities metro area is easier

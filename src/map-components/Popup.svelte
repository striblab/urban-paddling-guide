...
{#if popupData.headline}
    ...
    >
        <button class="absolute right-0 top-0 md:hover:opacity-50 transition-all duration-500 p-4 rounded-tr-xl md:p-4 " onclick={closeRoute}>
            <svg id="strib-close" viewBox="0 0 16 16" width="16" height="16" fill="#05442e" class="strib-icon strib-close" xmlns="http://www.w3.org/2000/svg">
              <path d="m8 7.037-5.5-5.5-.963.963 5.5 5.5-5.5 5.5.963.963 5.5-5.5 5.5 5.5.963-.963-5.5-5.5 5.5-5.5-.963-.963z"/>
            </svg>
        </button>
        <div
